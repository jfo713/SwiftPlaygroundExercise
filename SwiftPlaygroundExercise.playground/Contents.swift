...
var names :[String] = ["John", "Mary", "Alex", "Jack"]
...
let airports = ["Houston" : "IAH", "Costa Rica" : "San Jose Airport", "Los Angeles" : "LAX Airport"]
...
for (city, airportCode) in airports {
    ...
    print("Key = \(city), Value = \(airportCode)")
